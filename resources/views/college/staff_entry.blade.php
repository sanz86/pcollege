        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="{{ route('getFile',['image' => $staff->image_url) }}" alt="User profile picture">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Qualification</b> <a class="pull-right">{{ $staff->qualification }}</a>
                </li>
                <li class="list-group-item">
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#timeline" data-toggle="tab">Professional</a></li>
